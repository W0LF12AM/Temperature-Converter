...
class MainActivity : AppCompatActivity() {
    ...
    private val btnComa by lazy {findViewById<Button>(R.id.btn_coma)}
    private val btnOk by lazy {findViewById<Button>(R.id.btn_ok)}
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnClear.setOnClickListener { viewModel.clearInput() }
        ...
        btnComa.setButtonClickListener(".")
        ...
        btnOk.setOnClickListener { viewModel.convertUnit() }
    }
